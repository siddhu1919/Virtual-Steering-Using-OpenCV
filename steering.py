...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        if len(co) == 2:
            ...
            l = (
                int(math.sqrt((co[0][0] - co[1][0]) ** 2 * (co[0][1] - co[1][1]) ** 2))
                - 150
            ) // 2
            ...
            if co[0][0] > co[1][0] and co[0][1] > co[1][1] and co[0][1] - co[1][1] > 65:
                ...
                cv2.putText(
                    image, "Turn left", (50, 50), font, 0.8, (0, 255, 0), 2, cv2.LINE_AA
                )
                cv2.line(
                    image, (int(xbp), int(ybp)), (int(xm), int(ym)), (195, 255, 62), 20
                )

            elif (
                co[1][0] > co[0][0] and co[1][1] > co[0][1] and co[1][1] - co[0][1] > 65
            ):
                print("Turn left.")
                keyinput.release_key("s")
                keyinput.release_key("d")
                ...
                co[0][0] > co[1][0] and co[1][1] > co[0][1] and co[1][1] - co[0][1] > 65
            ):
                print("Turn right.")
                keyinput.release_key("s")
                ...
                cv2.line(
                    image, (int(xap), int(yap)), (int(xm), int(ym)), (195, 255, 62), 20
                )

            elif (
                co[1][0] > co[0][0] and co[0][1] > co[1][1] and co[0][1] - co[1][1] > 65
            ):
                print("Turn right.")
                keyinput.release_key("s")
                keyinput.release_key("a")
        ...
        if len(co) == 1:
            ...
            cv2.putText(
                image, "keeping back", (50, 50), font, 1.0, (0, 255, 0), 2, cv2.LINE_AA
            )
